...
export default function SignUp() {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="mx-auto w-full max-w-lg p-10 border border-black/10 bg-gray-100 rounded-lg">
        ...
        <p className="mt-2 text-center text-base text-black/60">
          ...
          <Link
            to="/login"
            className="font-medium transition-all hover:underline duration-200 text-primary"
          >
            Sign In
          </Link>
        </p>
